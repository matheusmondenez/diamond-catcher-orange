...
@onready var coins_counter: Label = $MarginContainer/CoinsCounter/Counter
@onready var timer_counter: Label = $MarginContainer/TimerCounter/Counter
@onready var score_counter: Label = $MarginContainer/ScoreCounter/Counter
@onready var lives_counter: Label = $MarginContainer/LivesCounter/Counter
